...
class ASPPModule(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.atrous_conv1 = nn.Conv2d(in_channels, out_channels, 1, 1)
        self.atrous_conv2 = nn.Conv2d(in_channels, out_channels, 3, 1, padding=6, dilation=6)
        self.atrous_conv3 = nn.Conv2d(in_channels, out_channels, 3, 1, padding=12, dilation=12)
        self.atrous_conv4 = nn.Conv2d(in_channels, out_channels, 3, 1, padding=18, dilation=18)
